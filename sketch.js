...
function preload(){
    ...
    batAnimation = loadAnimation("bat/bat1.png","bat/bat2.png","bat/bat3.png",
     ...
     man1 = loadAnimation("Walking Frame/walking_1.png",    
...
function draw(){
    ...
    //rain = createSprite(Math.round(random(0,400)),Math.round(random(700,400)));
    if(frameCount % 60 === 0){
    man = createSprite(200,580,100,100)
    man.addAnimation("walking_man",man1);
    man.scale = 0.4
    }
